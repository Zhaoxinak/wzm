...
- (void)setModel:(AllCommentsModel *)model {
    ...
    //时间
    self.timeLabelFrame = CGRectMake(CGRectGetMaxX(self.headImageViewFrame) + 10*WIDTH_NIT, CGRectGetMaxY(self.userNameLabelFrame) + 10*WIDTH_NIT, kScreen_Width/6, 20*WIDTH_NIT);
    ...
    if (comment.length >0) {
        ...
        self.titleNameLabelFrame = CGRectMake(10*WIDTH_NIT, 10*WIDTH_NIT, contentSize.width, contentSize.height);
    }else{
        self.titleNameLabelFrame = CGRectMake(10*WIDTH_NIT, 10*WIDTH_NIT, 0, 0);
    }
