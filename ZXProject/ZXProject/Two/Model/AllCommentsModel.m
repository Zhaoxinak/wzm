...
- (void)setModel:(AllCommentsModel *)model {
    ...
    //详情内容
    self.detailViewFrame = CGRectMake(15*WIDTH_NIT, CGRectGetMaxY(self.titleNameLabelFrame) + 10*WIDTH_NIT, kScreen_Width-30*WIDTH_NIT, 70*WIDTH_NIT);
    
    //总高度
    self.cellHeight = CGRectGetMaxY(self.detailViewFrame) + 30*WIDTH_NIT;
}
