//
//  OneModifiedWikiViewController.m
//  ZXProject
//
...
@interface OneModifiedWikiViewController ()

@end

@implementation OneModifiedWikiViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *cellIdentifier = [NSString stringWithFormat:@"OneModifiedWikiTableViewCell%ld", (long)indexPath.row];
    //首先根据标示去缓存池取
    OneModifiedWikiTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:cellIdentifier];;
    //如果缓存池没有取到则重新创建并放到缓存池中
    if(!cell){
        cell=[[OneModifiedWikiTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    return OneModifiedWikiCell_Height;
}
