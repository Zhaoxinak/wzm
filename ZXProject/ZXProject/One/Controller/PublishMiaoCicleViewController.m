//
//  PublishMiaoCicleViewController.m
//  ZXProject
//
...
/************C************/
#import "PublishMiaoCicleViewController.h"
/************V************/
#import "AddPartyTableViewCell.h" //cell视图
#import "AddPicturesCell.h" //添加图片
/************M************/
#import "AddNoteDataModel.h"  //上传数据
#import "AddPartyCellModel.h"  //cell数据
#import "AddPictureModel.h"    //图片数据


@interface PublishMiaoCicleViewController ()<AddPicturesCellDelegate, UIImagePickerControllerDelegate, QBImagePickerControllerDelegate, UINavigationControllerDelegate>
...
//添加数据模型
@property (nonatomic, strong) AddNoteDataModel *dataModel;

@end

@implementation PublishMiaoCicleViewController
...
- (void)setupDatas {
    ...
    _dataModel = [[AddNoteDataModel alloc] init];
