...
/************V************/
#import "ExperienceTableViewCell.h"  //心得
/************M************/
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(!cell){
        cell=[[ExperienceTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellIdentifier];
