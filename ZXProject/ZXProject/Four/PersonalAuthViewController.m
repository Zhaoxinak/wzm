...
@interface PersonalAuthViewController ()<AddAuthPicturesCellCellDelegate,UIImagePickerControllerDelegate,QBImagePickerControllerDelegate,UINavigationControllerDelegate>
...
- (void)setupCellModels {
    ...
    typeCell.titleText = @"擅长领域";
    typeCell.placeHolderText = @"请输入活动主题";
    typeCell.detailText = @"未设置";
    typeCell.placeHolderLeft = NO;
    ...
    AddPartyCellModel *exJobCell = [[AddPartyCellModel alloc] init];
    exJobCell.titleText = @"曾任职";
    exJobCell.placeHolderText = @"曾经职位";
    exJobCell.placeHolderLeft = YES;
    exJobCell.fullScreenSeperateLine = YES;
    exJobCell.selectType = AddPartyCellTypeTextField;
    
    AddPartyCellModel *nowJobCell = [[AddPartyCellModel alloc] init];
    nowJobCell.titleText = @"现任职";
    nowJobCell.placeHolderText = @"现任职位";
    nowJobCell.placeHolderLeft = YES;
    nowJobCell.fullScreenSeperateLine = YES;
    nowJobCell.selectType = AddPartyCellTypeTextField;
    
    AddPartyCellModel *companyCell = [[AddPartyCellModel alloc] init];
    companyCell.titleText = @"公司";
    companyCell.placeHolderText = @"现公司名称";
    ...
    managerCell.titleText = @"公司负责人";
    managerCell.placeHolderText = @"负责人名称";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        AddPartyCellModel *model = _dataArray0[indexPath.row];
